...
ActiveRecord::Schema[7.0].define(version: 2023_09_22_170005) do
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.index ["book_list_id"], name: "index_favorites_on_book_list_id"
  end
  ...
  add_foreign_key "favorites", "book_lists"
